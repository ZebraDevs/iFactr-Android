...
{
    public class CheckBox : Android.Widget.CheckBox, IButton, ISwitch, INotifyPropertyChanged
    {
        #region Constructors
        ...
        public CheckBox(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        [Preserve]
        public CheckBox(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
            Initialize(attrs);
        }
        ...
        [Preserve]
        public CheckBox(Context context, IAttributeSet attrs, int defStyleAttr)
        ...
        [Preserve]
        public CheckBox(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes)
        ...
        {
            CheckedChange += CheckBox_CheckedChange;
        ...
        private void CheckBox_CheckedChange(object sender, CheckedChangeEventArgs e)
        {
