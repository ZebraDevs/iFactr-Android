...
{
    public class DatePickerView : Button, IDatePicker, INotifyPropertyChanged
    {
        ...
        protected DatePickerView(IntPtr javaReference, JniHandleOwnership transfer)
        ...
        public void ShowPicker()
        {
            ...
            _datePicker = new DatePickerDialog(DroidFactory.MainActivity, 0, OnDateChanged, date.Year, date.Month - 1, date.Day);
            _datePicker.Show();
        }

        public void OnDateChanged(object sender, DatePickerDialog.DateSetEventArgs e)
        {
            Date = new DateTime(e.Year, e.MonthOfYear + 1, e.DayOfMonth);
        }
        ...
        public DateTime? Date
        {
            ...
            set
            {
                ...
                Device.Thread.ExecuteOnMainThread(() => { Text = value?.ToString(DateFormat ?? "d") ?? string.Empty; });
                this.OnPropertyChanged();
                this.OnPropertyChanged(nameof(StringValue));
                this.RaiseEvent(nameof(DateChanged), new ValueChangedEventArgs<DateTime?>(oldVal, value));
            }
        }
        ...
        public string DateFormat
        {
            ...
            set
            {
                ...
                _valueFormat = value;
                Text = Date?.ToString(DateFormat ?? "d") ?? string.Empty;
                this.OnPropertyChanged();
            }
        }
